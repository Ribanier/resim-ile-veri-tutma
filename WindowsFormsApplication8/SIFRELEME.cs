    ...
    public partial class SIFRELEME : Form
    {
                    ...
                    else
                    {
                        ...
                        using (OleDbCommand cmd = new OleDbCommand("select isim from verikayit  where isim = @isim", blnt))
                        {
                            ...
                            if (rd.Read())
                            {
                                ...
                                tp.ToolTipIcon = ToolTipIcon.Warning;
                                tp.ToolTipTitle = "Dikkat";
                                tp.IsBalloon = true;
                                tp.Show("\"" + rd["isim"].ToString() + "\"" + " Adındaki çözme kodu daha önce alınmış lütfen başka bir çözme kodu giriniz...", textBox3);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (a != "openFileDialog1")
            {
                ...
                MessageBox.Show("Resim seçilmedi lütfen resim seçiniz", "Dikkat", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
        ...
        {       
            ...
            aciklama.SetToolTip(this, "Konumlandırmak için tıklayın ve fareyi oynatın");
            aciklama.ToolTipTitle = "İpucu";
            aciklama.IsBalloon = true;
            aciklama.SetToolTip(button2, "Buradan şifreleceğimiz resmi seçiyoruz.");
            aciklama.SetToolTip(textBox3, "Buradaki kodu not etmeyi unutmayalım daha sonra lazım olacak!");
            aciklama.SetToolTip(pictureBox2, "Buradan anasayfaya gidebiliriz.");
            aciklama.SetToolTip(pictureBox5, "Buradan yeni resim şifresi çözmek için yeniden başlatabiliriz.");
            aciklama.SetToolTip(pictureBox4, "Burada uygulamayı kapatırız.");
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               DialogResult rs=MessageBox.Show("Lütfen resmin kaydedilecek konumunu seçin.","Dikkat",MessageBoxButtons.OKCancel,MessageBoxIcon.Asterisk);
                ...
                else { MessageBox.Show("Resim oluşturulamadı."); pictureBox1.Image = null; }
                }
                else { MessageBox.Show("Resim oluşturulamadı."); pictureBox1.Image = null; }
            }
            catch
